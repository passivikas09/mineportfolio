                            ...
                            <div className="d-flex justify-content-center mt-5 mt-xxl-0">
                                <div className="profile bg-gradient-primary-to-secondary">
                                    ...
                                    <div className="dots-1">
                                        {/* SVG Dots*/}
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 191.6 1215.4"  >
                                    ...
                                    <div className="dots-2">
                                        {/* SVG Dots*/}
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" viewBox="0 0 191.6 1215.4" style={{enableBackground: " 0 0 191.6 1215.4"}} >
                                            <g transform="translate(0.000000,1280.000000) scale(0.100000,-0.100000)">
                                                <path d="M227.7,12788.6c-105-35-200-141-222-248c-43-206,163-412,369-369c155,32,275,190,260,339c-11,105-90,213-190,262        C383.7,12801.6,289.7,12808.6,227.7,12788.6z"></path>
                                                <path d="M1507.7,12788.6c-151-50-253-216-222-362c25-119,136-230,254-255c194-41,395,142,375,339c-11,105-90,213-190,262        C1663.7,12801.6,1569.7,12808.6,1507.7,12788.6z"></path>
                                                <path d="M227.7,11508.6c-105-35-200-141-222-248c-43-206,163-412,369-369c155,32,275,190,260,339c-11,105-90,213-190,262        C383.7,11521.6,289.7,11528.6,227.7,11508.6z"></path>
                        ...
                        <div className="col-xxl-8">
                            <div className="text-center my-5">
                                ...
                                <div className="d-flex justify-content-center fs-2 gap-4">
                                    ...
                                    <Link className="text-gradient" to="https://github.com/passivikas09"><i className="bi bi-github"></i></Link>
                                </div>
                            </div>
                        </div>
                    </div>
